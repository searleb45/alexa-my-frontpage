...
var handlers = {
    ...
    'getSubredditIntent': function() {
        ...
        subredditList = [ removeDiacritics(subredditName) ];
    ...
    if( subredditList ) {
        ...
        httpGet('www.reddit.com', redditPath, (res) => {
            if( subredditList.length === 1 ) {
                ...
                readPostsFromMultiple(res.data.children.slice(0,5));
            }
        });
    } else {
...
// Remove any non-ASCII characters from the slot values passed from Amazon.
